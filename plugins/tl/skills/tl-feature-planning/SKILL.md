...
### 5b. Design evals for AI behaviours (applied-AI features only)
...
- **Design evals for AI behaviour.** An applied-AI feature isn't planned until its AI-driven acceptance criteria have runnable verifiers designed (`context/evals/`, via the `eval-engineering` skill) — you design them; the dev loop runs them. Deterministic features need none.
