...
Before the full evaluation, the audit checks whether the mandatory tooling baseline is in place — it reads `qa/quality-gates.md` (`baseline_status`) and the active `baseline-profile.md`. Behaviour:
