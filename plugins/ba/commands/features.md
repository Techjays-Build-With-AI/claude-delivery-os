---
description: Break the scope into an implementation-ready feature breakdown. Pass the scope path (defaults to ba/scope.md); the BA agent decomposes it into independently understandable features and writes a folder per feature (feature.md, implementation-plan.md, workflow.md, acceptance-criteria.md, dependencies.md, open-questions.md, status.md) plus a feature-index under features/. It marks assumptions and open questions instead of inventing requirements, preserves traceability to the scope, and updates existing feature folders in place on re-runs.
